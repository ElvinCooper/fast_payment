...
def test_validar_monto_pago_exito():
    ...
    cursor.fetchone.return_value = (10000.0, 5000.0, 500.0)  # vprestamo, deuda_al_dia, mora_total
    ...
    assert resultado['puede_pagar'] == True
...
def test_validar_monto_pago_excede_deuda():
    ...
    assert resultado['mora_total'] == 500.0
    assert resultado['total_deuda'] == 5500.0
    assert resultado['puede_pagar'] == False
...
def test_validar_monto_pago_sin_deuda():
    ...
    cursor.fetchone.return_value = (10000.0, 0.0, 0.0)  # vprestamo, deuda_al_dia, mora_total
